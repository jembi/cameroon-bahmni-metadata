...
WHERE
    ...
    patientWasOnARVTreatmentDuringEntireReportingPeriod(pat.patient_id, p_startDate, p_endDate) AND
...
WHERE
    ...
    IF (
        ...
        patientWasOnARVTreatmentDuringEntireReportingPeriod(pat.patient_id, p_startDate, p_endDate),
...
WHERE
    ...
    IF (
        isOldPatient(pat.patient_id, p_startDate),
        patientWasOnARVTreatmentDuringEntireReportingPeriod(pat.patient_id, p_startDate, p_endDate),
        patientPickedFirstLineARVDrugDuringReportingPeriod(pat.patient_id, p_startDate, p_endDate)
    ) AND
    patientIsNotDead(pat.patient_id) AND
    patientIsNotLostToFollowUp(pat.patient_id) AND
    patientIsNotTransferredOut(pat.patient_id);
