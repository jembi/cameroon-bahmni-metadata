...
INSERT IGNORE INTO person (uuid,gender,date_created,creator)
    VALUES ('3f64faba-ad31-11e9-a2a3-2a2ae2dbcce4','F',NOW(),'4');
...
INSERT IGNORE INTO person (uuid,gender,date_created,creator)
    VALUES ('3f64fd1c-ad31-11e9-a2a3-2a2ae2dbcce4','F',NOW(),'4');
...
INSERT IGNORE INTO person (uuid,gender,date_created,creator)
    VALUES ('3f64fe70-ad31-11e9-a2a3-2a2ae2dbcce4','F',NOW(),'4');
...
SET @reception_user_id = (SELECT user_id FROM users WHERE username = 'Reception');
