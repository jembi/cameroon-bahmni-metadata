...
update clinlims.type_of_sample set is_active='Y' where description in ('Arteriall blood','Blood culture bottle','CSF sample','ESR tube','Plasma EDTA','Plasma Sodium citrate','Puncture liquid sample','Sperm','Serum','Sputum','Stool','Urethral smear sample','Urine sample','Urine Sediments sample','Vaginal Cervical smear sample','Other Samples');